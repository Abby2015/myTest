...
//api.ready做的事
smartMobile.apiReady(function() {
	$.am.elements && $.am.elements.init();
	var device = window.device;
	$.am.relativePath = smartMobile.app && smartMobile.app.sourceRoot && device.platform != "Android";
	...
	$.am.innerWidth = window.innerWidth > 500 ? 500 : window.innerWidth;
});
