	...
	var mobileApi = {
		...
		webService : {
		    execServiceConnector : function(option, successCallback,
				...
				var data = {
                    ...
                    "mobilet":"ORDERING",
                    "dataType":"JSON",
                    "resouceVersion":atMobile.app.resourceVersion || "2.032",
                    "apkVersion":atMobile.app.apkVersion || "3",

                    deviceId: atMobile.app.deviceId || "00000000000",
                    mobilet: "KFC_mos3",
                    versionFlag: "P",
                    macAddress: atMobile.app.macAddress || "0000-0000-0000-0000",
				    "data": option
				}
		...
		execNativeAPI : function(serviceName, actionName, option,
			...
			if (!window.device) {
				...
				console.log("yqa===>AtMobileApi未初始化");
		...
		// mobilet开发人员需要将所有涉及取atmobile数据的请求放置在apiReady事件内执行

		Init : function() {
			window.atMobile.container = {version:"1.0"};
			window.atMobile.app = {id:"Mock",sourceRoot:""};
		},
	...
	document.addEventListener("deviceready", function () {
	    ...
	    yum.sys.getInfo(function (ret) {
            ...
            if (ret && ret.result == 0) {
                ...
                window.atMobile.app = extend(window.atMobile.app, ret.content);
            } else {
	        ...
	        yum.appInfo.getAppInfo(function (ret) {
	            if (ret && ret.result == 0) {
	                ...
	                /*if (device.platform == "Android") {
	                    window.atMobile.app.version = "A_" + window.atMobile.app.version;
	                } else {
	                    window.atMobile.app.version = "I_" + window.atMobile.app.version;
	                }*/
	            } else{
	                if (typeof ret.content == "string") {
	                    content = JSON.parse(ret.content);
	                ...
	                window.atMobile.app = extend(window.atMobile.app, ret);
	                /*if (device.platform == "Android") {
	                    window.atMobile.app.version = "A_" + window.atMobile.app.version;
	                } else {
	                    window.atMobile.app.version = "I_" + window.atMobile.app.version;
