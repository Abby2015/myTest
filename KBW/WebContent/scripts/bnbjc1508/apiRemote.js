...
//		selfRef: "http://t.a.kfc.com.cn/brandkfc_bnbjc/",
//		selfRoot: "http://t.a.kfc.com.cn/brandkfc_bnbjc/",
//		redirectUrl : "http://t.a.kfc.com.cn/brandkfc_bnbjc/api/bnbjc1508/wx_redirect.do"
		
		selfRoot: "http://summer.kfc.com.cn/brandkfc_bnbjc/",
		selfRef: "http://summer.kfc.com.cn/BNBJC/",
		redirectUrl : "http://summer.kfc.com.cn/brandkfc_bnbjc/api/bnbjc1508/wx_redirect.do"
	}
};
...
$(function () {
    ...
    amGloble.api = {
            a01: new amGloble.Api(
                {
                    url: amGloble.config.selfRoot + 'api/bnbjc1508/open?rd=' + ('v'+Math.random()).replace('.','')
                }
            ),
            a03: new amGloble.Api(
            		{
            			url: amGloble.config.selfRoot + 'api/bnbjc1508/collect?rd=' + ('v'+Math.random()).replace('.','')
            		}
            ),
            a04: new amGloble.Api(
            		{
            			url: amGloble.config.selfRoot + 'api/bnbjc1508/share?rd=' + ('v'+Math.random()).replace('.','')
            		}
            ),
		    a08: new amGloble.Api(
		    		{
		    			url: amGloble.config.selfRoot + 'api/bnbjc1508/getThirdWechatState?rd=' + ('v'+Math.random()).replace('.','')
		    		}
		    )
        	// ...
    };
