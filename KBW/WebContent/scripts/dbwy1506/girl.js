...
//        	alert(" ===index.html=== \n"+JSON.stringify(location));
        	...
        	//初始化节点
        	this.$page4page2girl = $(".page2.girl");
        	...
        	this.$touch4Ticket_page2_girl = $(".ticket_button.page2_girl");
        	this.$touch4GirlShare = $(".ticket_help.girl,.ticket_button.ticket_help");
...
//        	this.$touch4care = $(".click_care_btn");
        	...
        	/*this.$touch4care.bind("click",function(){
        		location.href= amGloble.config.selfRoot + "pages/dbwy1506/mobile2.html?foid="+localStorage.getItem("openid")+"&tag="+sessionStorage.getItem("tag")+"&normalShare=1";
        	});*/
        	...
        	this.$touch4Back.bind("click",function(){
        		...
        		_this.$page4page2girl.show();
        	});
        	this.$touch4Ticket_page2_girl.bind("click",function(){
        		var promoCode = sessionStorage.getItem("promoCode");
        		if(promoCode=="" || promoCode=="null" || promoCode==null){
        			_this.$page4page2girl.hide();
        	...
        	this.$touch4GirlShare.bind("click",function(){
        		if (window._tag) { 
            		_tag.dcsMultiTrack("wt.event", "用户开始分享[文艺青年页面]", "wt.msg", localStorage.getItem("openid"));
            	}
...
//        		alert("[-a04- return]" + JSON.stringify(ret));
        		if (window._tag) { 
        			_tag.dcsMultiTrack("wt.event", "用户点击查看半价券[文艺青年页面]", "wt.msg", localStorage.getItem("openid"));
        		}
...
//        			alert(JSON.stringify(ret));
        			...
        			if (window._tag) { 
                		_tag.dcsMultiTrack("wt.event", "用户查看卡包[文艺青年页面]", "wt.msg", localStorage.getItem("openid"));
                	}
        ...
        askFriend : function(type){
        	...
        	if(type == "boy"){
        		askType_ = "0";
        		if (window._tag) { 
            		_tag.dcsMultiTrack("wt.event", "用户求助逗比青年[文艺青年页面]", "wt.msg", localStorage.getItem("openid"));
            	} 
        	}else{
        		askType_ = "1";
        		if (window._tag) { 
            		_tag.dcsMultiTrack("wt.event", "用户求助文艺青年[文艺青年页面]", "wt.msg", localStorage.getItem("openid"));
            	} 
        	}
        	var opt = {
...
//        			alert(JSON.stringify(ret));
        			...
        			if (window._tag) { 
                		_tag.dcsMultiTrack("wt.event", "用户分享成功[文艺青年页面]", "wt.msg", localStorage.getItem("openid"));
                	} 
