...
//	        			alert(JSON.stringify(ret));
	        			location.href=amGloble.config.selfRoot + "api/dbwy1506/login.do";
	        		} else {
	        			...
	        			if(isOutOfDate_=="true" || isOutOfDate_==true){
	        				location.href=amGloble.config.selfRoot + "pages/dbwy1506/finish.html";
	        			}else{
	        				if(drawCoupon == true || drawCoupon == "true"){
//		        				alert(amGloble.config.selfRoot + 'pages/dbwy1506/success.html?foid='+_this.getCoid()+"&tag="+ret.content.data.tag+"&normalShare=0");
		        				location.href=amGloble.config.selfRoot + 'pages/dbwy1506/success.html?foid='+_this.getCoid()+"&tag="+ret.content.data.tag+"&normalShare=0";
		        			}else{
//		        				alert(amGloble.config.selfRoot + 'pages/dbwy1506/fail.html?foid='+_this.getCoid()+"&tag="+ret.content.data.tag+"&normalShare=0");
		        				location.href=amGloble.config.selfRoot + 'pages/dbwy1506/fail.html?foid='+_this.getCoid()+"&tag="+ret.content.data.tag+"&normalShare=0";
		        			}
	        			}
	        		}
