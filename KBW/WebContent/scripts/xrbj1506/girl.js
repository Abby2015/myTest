...
//        	alert(" ===index.html=== \n"+JSON.stringify(location));
        	...
        	this.$touch4GirlShare.bind("click",function(){
        		if (window._tag) { 
            		_tag.dcsMultiTrack("wt.event", "用户开始分享[闺蜜页面]", "wt.msg", localStorage.getItem("openid"));
            	}
...
//        		alert("[-a04- return]" + JSON.stringify(ret));
        		if (window._tag) { 
        			_tag.dcsMultiTrack("wt.event", "用户点击查看半价券[闺蜜页面]", "wt.msg", localStorage.getItem("openid"));
        		}
...
//        			alert(JSON.stringify(ret));
        			...
        			if (window._tag) { 
                		_tag.dcsMultiTrack("wt.event", "用户查看卡包[闺蜜页面]", "wt.msg", localStorage.getItem("openid"));
                	}
        ...
        askFriend : function(type){
        	...
        	if(type == "boy"){
        		askType_ = "1";
        		if (window._tag) { 
            		_tag.dcsMultiTrack("wt.event", "用户求助ji友[闺蜜页面]", "wt.msg", localStorage.getItem("openid"));
            	} 
        	}else{
        		askType_ = "0";
        		if (window._tag) { 
            		_tag.dcsMultiTrack("wt.event", "用户求助闺蜜[闺蜜页面]", "wt.msg", localStorage.getItem("openid"));
            	} 
        	}
        	var opt = {
...
//        			alert(JSON.stringify(ret));
        			...
        			if (window._tag) { 
                		_tag.dcsMultiTrack("wt.event", "用户分享成功[闺蜜页面]", "wt.msg", localStorage.getItem("openid"));
                	} 
